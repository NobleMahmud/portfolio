...
const Home = () => {
    ...
    <div className="drawer-content fixed top-0 left-0 z-20 w-64 h-full transition-all duration-500 transform -translate-x-full bg-white shadow-lg peer-checked:translate-x-0">
        <ul className="menu p-4 min-h-full text-base-content">
            ...
            <div className="drawer">
                ...
                <div className="drawer-content fixed top-0 right-0 z-20 w-64 h-full transition-all duration-500 transform translate-x-full bg-white shadow-lg peer-checked:translate-x-0">
