    ...
    return (
        ...
        <div className="bg-white min-h-screen flex flex-col-reverse md:flex-row items-center justify-center px-16">
            <div className="relative w-full max-w-lg">
                ...
                <div className="absolute -bottom-32 left-20 w-72 h-72 bg-purple-700 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse animation-delay-4000"></div>
