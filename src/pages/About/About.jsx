    ...
    return (
        <div id="about"  className="bg-cover bg-no-repeat">
            <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
                ...
                <div
                    className="w-full lg:w-3/5 rounded-lg shadow-2xl bg-transparent backdrop-blur-2xl opacity-75 mx-6 lg:mx-0">
                    ...
                    <div className="p-4 md:p-12 text-center lg:text-left">
                        ...
                        <div className="pt-12 pb-8">
                            <Link
                                ...
                                smooth={true}
                                offset={50}
                                duration={500}><button className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                                    Get In Touch
                                </button></Link>
                        </div>
                ...
                <div className="w-full lg:w-2/5">
                    <img src="https://i.ibb.co/VVkFr4v/IMG-20230224-WA0016.jpg" className="rounded-none lg:rounded-lg shadow-2xl hidden lg:block" />
