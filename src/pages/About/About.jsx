...
<div id="profile"
    ...
    <div class="p-4 md:p-12 text-center lg:text-left">
        ...
        <h1 class="text-3xl font-bold pt-8 lg:pt-0">About Myself</h1>
...
<div class="w-full lg:w-2/5">
    <img src="https://i.ibb.co/VVkFr4v/IMG-20230224-WA0016.jpg" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block"/>
